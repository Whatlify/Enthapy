...
public sealed class FlatTrackBar : Control
{
    ...
    public FlatTrackBar(int int_7, int int_8, int int_9)
    {
    ...
    public async void method_1()
    {
        try
        {
            ...
            while (bool_5)
            {
                ...
                if (decimal_0 < num)
                {
                    decimal num2 = (num - decimal_0) * 0.15m;
                    decimal_0 += num2;
                    Invalidate();
                }
                if (decimal_0 > num)
                {
                    decimal num3 = (num - decimal_0) * 0.15m;
                    decimal_0 += num3;
                    Invalidate();
                }
            }
    ...
    private void method_2(PaintEventArgs paintEventArgs_0, Color color_6)
    {
        ...
        if (Boolean_0)
        {
            ...
            paintEventArgs_0.Graphics.DrawString(Int32_0.ToString(), font, new SolidBrush(ForeColor), new Rectangle(0, 0, Width, Height + 2), new StringFormat
            {
